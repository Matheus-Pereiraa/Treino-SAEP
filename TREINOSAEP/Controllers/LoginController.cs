...
namespace TREINOSAEP.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,idPerfil,Senha")] Usuarios usuarios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,idPerfil,Senha")] Usuarios usuarios)
        {
            if (id != usuarios.Id)
            {
                return NotFound();
